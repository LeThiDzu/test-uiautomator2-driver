...
Beta
    ...
    Log To Console    ${env_vars['APPIUM_HOST']}:${env_vars['APPIUM_PORT']}
    Open Application    ${env_vars['APPIUM_HOST']}:${env_vars['APPIUM_PORT']}    platformName=${env_vars['PLATFORM_NAME']}    platformVersion=${Platform_Version}
